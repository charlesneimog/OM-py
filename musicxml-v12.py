...
def fix_nested_tuplets(tuplet):
    ...
    print(f' ========= COMPASSO {measure_number} ================= ')
    ...
    for measure in all_measures:
        ...
        for notes_and_rests in measure.notesAndRests: 
            ...
            if len(duration.tuplets) != 0: # Se tiver tuplets com uma camada
                ...
                print('tuplet duration', int(names2ratio(duration.tuplets[index_of_the_tuplet].tupletNormal[1].type) / duration.tuplets[index_of_the_tuplet].numberNotesNormal))
                if tie == 'start':
                    ha_tie = True
