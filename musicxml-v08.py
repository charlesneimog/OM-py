...
''' 
Nessa versão,compassos com notas pontuadas não funcionam direitoelas precisam ser repensadas comoo valor da da primeira quialtera é decidida!

O compasso ((5 8) (6 6 (8 (1 1 1)))))) é escrito desta forma ((5 8) (6 6 (4 (1 1 1))))))
...
def fix_nested_tuplets(tuplet):
    ...
    compass_number = list(map(lambda x: x[1].numero_do_compasso, tuplet))[0]
    print(f'========================== COMPASSO {compass_number} ======================================')
    nested = True
    normal_notes = None
    actual_pulses = []
    final_tree = []
    ...
    index = 0
    max_tuplet_level = max(list(map(lambda x: x[1].max_level_of_tuplets, tuplet)))
    ...
    for x in tuplet:
        ...
        ## ================================
        #print('min tuplet level: ', x[1].min_level_of_tuplets)
        ...
        if x[1].tuplet_level == 1:
            ...
            if x[2] == 'start':
                ...
                #print('duration_of_tuplet 1', duration_of_tuplet_1)
                #print('fix when have dots', fix_when_have_dots, x[1].min_level_of_tuplets)
        ...
        for notes_and_rests in measure.notesAndRests: 
            ...
            #############################################
                ...
                if isRest:
                    ...
                    local_om_pulse.numero_do_compasso = numero_do_compasso
                    local_om_pulse.min_level_of_tuplets = min_level_of_tuplets
                    local_om_pulse.max_level_of_tuplets = max_level_of_tuplets
                    local_om_pulse.time_signature = TimeSignature[0]
